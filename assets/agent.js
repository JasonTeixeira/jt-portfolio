...
(function () {
  ...
  var GUIDED = {
    ...
    cost: { clip: 'cost', next: ['howItWorks', 'onCall', 'book'],
      en: "Common needs have a fixed price — a $497 AI Quality Audit, packaged builds from $4,997, and monthly care from $299/mo. Larger builds get a custom quote after a short call, or in 2 minutes with the Scope Studio. The lowest-risk start is that free mini-evaluation. Want it?",
      es: "Los casos comunes tienen precio fijo — una Auditoría de Calidad de IA de $497, paquetes desde $4,997 y mantenimiento mensual desde $299/mes. Los proyectos más grandes se cotizan tras una breve llamada, o en 2 minutos con el Scope Studio. El inicio con menos riesgo es esa mini-evaluación gratuita. ¿La quieres?",
      pt: "As necessidades comuns têm preço fixo — uma Auditoria de Qualidade de IA de $497, pacotes a partir de $4.997 e manutenção mensal a partir de $299/mês. Projetos maiores são orçados após uma conversa rápida, ou em 2 minutos com o Scope Studio. O ponto de partida de menor risco é aquela mini-avaliação gratuita. Quer?" },
  ...
  var FALLBACK = [
    { re: /price|cost|\$|how much|pay|budget|rate|quote|precio|cu[aá]nto|cuesta|presupuesto|tarifa|pre[çc]o|quanto|or[çc]amento/i,
      en: "Common needs have a fixed price — a $497 AI Quality Audit, builds from $4,997, care from $299/mo — plus a custom quote for larger builds. The lowest-risk start is free: Jason runs a real eval on your live AI feature and sends the findings. Want that?",
      es: "Los casos comunes tienen precio fijo — una Auditoría de $497, paquetes desde $4,997, mantenimiento desde $299/mes — más una cotización a medida para proyectos grandes. El inicio con menos riesgo es gratis: Jason corre una evaluación real sobre tu función de IA en vivo y te envía los hallazgos. ¿La quieres?",
      pt: "As necessidades comuns têm preço fixo — uma Auditoria de $497, pacotes a partir de $4.997, manutenção a partir de $299/mês — mais um orçamento sob medida para projetos grandes. O começo de menor risco é grátis: o Jason roda uma avaliação real no seu recurso de IA ao vivo e te envia os resultados. Quer?" },
  ...
  var CLIP_BASE = '/assets/concierge/' + VLANG + '/', CLIP_V = '?v=7';
