...
export const DEFAULTS_BY_VERTICAL = {
  ...
  'real estate': ['speed-to-lead', 'ai-receptionist', 'nurture-sequences', 'missed-call-textback'],
  'insurance agency': ['speed-to-lead', 'ai-receptionist', 'quote-estimate', 'nurture-sequences'],
  'mortgage / lending': ['speed-to-lead', 'intake-automation', 'nurture-sequences', 'ai-receptionist'],
  'med spa / clinic': ['ai-receptionist', 'booking-reminders', 'website-assistant', 'review-engine'],
  'dental': ['ai-receptionist', 'booking-reminders', 'intake-automation', 'review-engine'],
  'veterinary': ['ai-receptionist', 'booking-reminders', 'missed-call-textback', 'review-engine'],
  'specialty health': ['ai-receptionist', 'booking-reminders', 'intake-automation', 'review-engine'],
  'property management': ['ai-receptionist', 'missed-call-textback', 'crm-workflow', 'doc-processing'],
  'accounting / tax': ['intake-automation', 'doc-processing', 'nurture-sequences', 'ai-receptionist'],
  'agency': ['crm-workflow', 'nurture-sequences', 'reporting', 'website-assistant'],
  'financial advisor': ['speed-to-lead', 'nurture-sequences', 'intake-automation', 'ai-receptionist'],
  'dealership': ['speed-to-lead', 'ai-receptionist', 'nurture-sequences', 'review-engine'],
  'senior / home care': ['ai-receptionist', 'intake-automation', 'missed-call-textback', 'nurture-sequences'],
  'staffing / recruiting': ['speed-to-lead', 'intake-automation', 'nurture-sequences', 'crm-workflow'],
  'local service': ['ai-receptionist', 'missed-call-textback', 'quote-estimate', 'review-engine'],
  'medical': ['ai-receptionist', 'booking-reminders', 'intake-automation', 'review-engine'],
  'fitness / salon': ['booking-reminders', 'website-assistant', 'nurture-sequences', 'review-engine'],
  'education': ['ai-receptionist', 'booking-reminders', 'nurture-sequences', 'website-assistant'],
  'events / lifestyle': ['website-assistant', 'nurture-sequences', 'review-engine', 'ai-receptionist'],
