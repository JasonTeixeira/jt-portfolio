...
export const SERVICES = [
  {
    ...
    proof: [
      { name: 'nexural-qa-os', metric: '85 quality runners, 10 dedicated AI-safety evals, 13/13 proof gates — reproducible by one command', href: '/index.html#work' },
  ...
  },
  {
    ...
    proof: [
      ...
      { name: 'This site', metric: '53 checks (smoke + a11y, desktop & mobile) gate every push of the page you\'re reading — the scorecard on the homepage is generated by the suite', href: '/index.html#proof' }
    ],
    faq: [
