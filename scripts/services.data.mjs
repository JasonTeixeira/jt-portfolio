 ...
 *
 * Quote-first model: no public prices. Every engagement is scoped and quoted
 * after a short conversation, so all package CTAs route to the booking/contact
 * flow. Keep it that way — no dollar figures in this file.
 */
...
export const SERVICES = [
  {
    ...
    packages: [
      { name: 'Eval Audit', timing: '~1 week', d: 'I map where your LLM feature can fail, score your current coverage against the failure modes that matter, and hand you a prioritized plan you own. The fastest way to a concrete quote.', cta: 'book' },
      { name: 'Minimum Viable Gate', timing: '~2 weeks', d: '30–50 golden traces, one judge, one CI step that can block a merge. The regression you currently can\'t see, caught this month.', cta: 'book' },
      { name: 'Full Eval Battery', timing: '~4–8 weeks', d: 'Safety runners, ratcheting floors, RAG retrieval metrics, cost budgets, runbook and handoff — the complete quality system, owned by your team.', cta: 'book' },
    ],
    faq: [
  ...
  },
  {
    ...
    packages: [
      { name: 'Suite Audit', timing: '~1 week', d: 'Risk map of your release path, honest read on the current suite (including whether it\'s worth saving), and a prioritized plan you own — the fastest way to a concrete quote.', cta: 'book' },
      { name: 'Stabilize Sprint', timing: '~2 weeks', d: 'The flake protocol installed on your existing suite: quarantine lane, retry policy, isolation fixes — red becomes meaningful again.', cta: 'book' },
      { name: 'Regression Suite Build', timing: '~4–8 weeks', d: 'Risk-scoped Playwright/Pytest coverage with traces, reporters, CI wiring, and the discipline documents your team maintains after I leave.', cta: 'book' },
    ],
    faq: [
  ...
  },
  {
    ...
    packages: [
      { name: 'Automation Audit', timing: '~1 week', d: 'I map your intake → decision → action flows, find the single highest-leverage automation, and hand you a plan with the risk gates drawn in — the fastest way to a concrete quote.', cta: 'book' },
      { name: 'One-Workflow Sprint', timing: '~2 weeks', d: 'One scoped workflow shipped end-to-end in your accounts — intake, classify, route, act — with human approval points and full run logs.', cta: 'book' },
      { name: 'Automation System Build', timing: '~4–8 weeks', d: 'The full pipeline: multiple workflows, eval-gated AI steps, cost model, structured outputs, runbook and handoff.', cta: 'book' },
    ],
    faq: [
