...
test.describe('portfolio — standalone booking', () => {
  test('book.html loads with a working form and a quote-first audit section', async ({ page }) => {
    await page.goto('/book.html');
    await expect(page.locator('h1').first()).toContainText('slipping through the cracks');
...
test.describe('portfolio — lead magnet + concierge', () => {
  ...
  test('AI associate (Nadine) mounts on the core pages', async ({ page }) => {
  ...
  test('Nadine opens, replies (scripted fallback offline), and offers actions', async ({ page }) => {
    await page.goto('/');
  ...
  test('Nadine hero launcher opens the associate from the homepage', async ({ page }) => {
    await page.goto('/');
