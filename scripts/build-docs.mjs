...
<body>
  <div class="d-top">
    <button class="d-menu-btn" id="d-menu" aria-label="Toggle documentation menu" aria-expanded="false">☰</button>
    ...
    <button class="d-search" id="d-search-btn" aria-label="Search documentation"><span>🔍</span><span class="d-search-lbl">Search the docs…</span><kbd>⌘K</kbd></button>
    <div class="d-top-cta">
